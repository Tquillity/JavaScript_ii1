...
function attachEventListeners(): void {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (loginForm && showLoginFormButton && !loginForm.contains(e.target as Node) && !showLoginFormButton.contains(e.target as Node) && !loginForm.classList.contains('hidden')) {
            loginForm.classList.add('hidden');
        }
    });
}
